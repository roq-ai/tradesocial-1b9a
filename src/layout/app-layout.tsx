...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['trader', 'investor', 'crypto-trader'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bookmarks', path: '/bookmarks', entity: 'bookmark', service: AccessServiceEnum.PROJECT, icon: FiBookmark },
    { name: 'Charts', path: '/charts', entity: 'chart', service: AccessServiceEnum.PROJECT, icon: FiBarChart },
    ...
    { name: 'Stats', path: '/stats', entity: 'stats', service: AccessServiceEnum.PROJECT, icon: FiActivity },
