...
import { getStatsById } from 'apiSdk/stats';
import { StatsInterface } from 'interfaces/stats';

function StatsViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Gain" text={data?.gain} />

                <FormListItem label="Fail Success Ratio" text={data?.fail_success_ratio} />
